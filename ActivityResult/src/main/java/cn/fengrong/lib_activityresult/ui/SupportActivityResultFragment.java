...
public class SupportActivityResultFragment extends Fragment {
    ...
    public static SupportActivityResultFragment newInstance(@NonNull final Intent intent, int requestCode) {
        final Bundle args = new Bundle();
        args.putParcelable(INTENT_TO_START, intent);
        args.putInt(INTENT_TO_REQUEST_CODE, requestCode);
        final SupportActivityResultFragment fragment = new SupportActivityResultFragment();
